 ...
 */
function crc32$1( buffer, seed, table ) {

  var crc = seed ^ -1;
  var length = buffer.length - 15;
  var TABLE = table || crc32$1.TABLE.DEFAULT;
  var i = 0;
 ...
 * @returns {CRC32Stream}
 */
crc32$1.Hash = class CRC32Stream extends stream.Transform {
  ...
  constructor( options ) {
    ...
    this.crc = options && options.seed != null ?
      options.seed : 0;
    this.crcTable = options && ( options.table || crc32$1.TABLE.DEFAULT );
  }
  ...
  _transform( chunk, _, next ) {
    ...
    this.crc = crc32$1( chunk, this.crc, this.crcTable );
    next();
  }
 ...
 * @returns {crc32.Hash}
 */
crc32$1.createHash = function createHash() {
  return new crc32$1.Hash()
};
...
function checksumFromStream(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    fs.createReadStream(filePath)
                        .pipe(crc32_1.createHash())
...
function createChecksum(files, printOutput) {
    return __awaiter(this, void 0, void 0, function () {
        var checksum;
        var _this = this;
        return __generator(this, function (_a) {
                    ...
                    return [4 /*yield*/, Promise.all(files.map(function (file) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.trys.push([1, 3, , 4]);
                                        return [4 /*yield*/, checksumFromStream(file)];
                                    case 2:
                                        checksum = _a.sent();
                                        if (!printOutput)
