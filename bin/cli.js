...
var stream__default = /*#__PURE__*/_interopDefaultLegacy(Stream__default['default']);
var globby__default = /*#__PURE__*/_interopDefaultLegacy(globby$1);
...
var EE = events_1__default['default'];
/* istanbul ignore if */
...
// TODO: Remove this for the next major release
var _default$2 = spinners;
cliSpinners.default = _default$2;
                                                ...
                                                return __awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_b) {
                                                        switch (_b.label) {
                                                            ...
                                                            case 3:
                                                                e_1 = _b.sent();
                                                                spinner.fail(file + " " + source.red(checksum) + " " + source.dim(e_1));
                                                                if (failFast) {
                                                                    throw 'Failing fast';
                                                                }
                                                                else {
                                                            ...
                                                            case 4:
                                                                if (checksum === actualChecksum) {
                                                                    spinner.succeed(file + " " + source.blue(checksum));
                                                                }
                                                                else {
                                                                    spinner.fail(file + " " + source.red(checksum) + " (actual: " + source.blue(actualChecksum) + ")");
                                                                    if (failFast)
                                                                        throw 'Failing fast';
                                                                }
                                                                return [2 /*return*/];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        e_2 = _a.sent();
                                        if (options.failFast) {
                                            spinner.fail(file + " " + source.dim(e_2));
...
function printTitle() {
    ...
    var linkedTitle = terminalLink_1(title, meta.homepage, {
        fallback: function () {
...
function readSFV(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs$2.promises.readFile(filePath)];
                case 1:
...
function setComment(options) {
    ...
    return ((_a = options.comment) === null || _a === void 0 ? void 0 : _a.length) ? "; " + String(options.comment) + "\n;"
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fs$2.promises.writeFile(outputFile, fileContents)];
                case 2:
                    _a.sent();
                    if (!options.print)
                ...
                case 3:
                    e_3 = _a.sent();
                    if (!options.print)
                        spinner.fail(outputFile + " " + source.dim(e_3));
                    return [3 /*break*/, 4];
...
const EventEmitter = events_1__default['default'].EventEmitter;
...
commander
    ...
    .parse(process.argv);
var completedIn = '\n✨ Completed in';
var lineBreak = commander.winsfv
    ? '\r\n'
    : '\n';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sfvFile.unshift(setComment({ comment: commander.comment, winsfv: commander.winsfv }));
                    outputString = commander.sort
                        ? sfvFile.sort().join(lineBreak)
                        : sfvFile.join(lineBreak);
                    if (!commander.output) return [3 /*break*/, 3];
                    writeOptions = {
                        algorithm: algorithm,
                        print: commander.print
                    };
                    return [4 /*yield*/, writeSFV(commander.output, outputString, writeOptions)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
